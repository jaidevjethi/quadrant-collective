...
export const caseStudies: CaseStudy[] = [
  {
    ...
    image: "/work/pramukh-hero.webp",
    gallery: [
      { src: "/work/pramukh-hero.webp", caption: "The site leads with the specialist and one promise: pain-free dentistry, right here in Mehsana. Trust before treatment." },
      { src: "/work/pramukh-clinic.webp", caption: "The clinic on its own building in Mehsana. Real local presence, and the anchor every nearby search for a dentist points to.", contain: true },
      { src: "/work/pramukh-operatory.webp", caption: "A real operatory, not a stock photo. The environment does the reassurance the words can only claim." },
      { src: "/work/pramukh-microscope.webp", caption: "Microscope-assisted dentistry, shown rather than stated. The precision behind the promise of a saved tooth." },
      { src: "/work/pramukh-care.webp", caption: "Credentials framed on the wall. In healthcare, proof of qualification is the quiet close." },
    ],
    results: [
  ...
  },
  {
    ...
    image: "/work/divyam-hero.webp",
    gallery: [
      { src: "/work/divyam-hero.webp", caption: "Dawn on the ghats, shot like a film. The art direction does the trust work a booking form cannot." },
      { src: "/work/divyam-route.webp", caption: "A page for each place pilgrims actually search. Sarnath at first light, met with real intent." },
      { src: "/work/divyam-fleet.webp", caption: "The fleet, shown plainly. A traveller books the car they can see.", contain: true },
      { src: "/work/divyam-packages.webp", caption: "Packages priced and timed for a quick decision, the direct path that keeps the margin off the aggregators." },
      { src: "/work/divyam-aarti.webp", caption: "The Ganga aarti. A voice and a look that read like a local who grew up here, not a template.", contain: true },
    ],
    results: [
